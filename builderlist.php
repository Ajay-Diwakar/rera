...
<h2 style="color:#7E94FF"> Approved Agent Report</h2>
<h4>select agent to view project <h4>

<form method="post" action="builderlistvalidate.php">
...
{
  <tr>
  <td> <?php echo $x->builderid;?></td>
  <td> <?php echo $x->organisationname;?></td>
  <td><input type="radio" name="select" value="<?php $x->builderid ?>" ></td>
  </tr>
}
@endforeach
