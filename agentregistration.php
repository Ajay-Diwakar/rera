...
<div class="jumbotron" style="text-align:justify;opacity: 0.96;padding-right: 80px;padding-left: 80px;width:100%">
...
<h3 style="color:#30B1C8">General Instructions :</h3>
	...
	<button type="button" class="btn btn-success btn-md"><a href="agentreg1.php">Proceed</a></button>
	</div>
</div>
