...
<h2>Preview</h2>
  ...
  <div class="progress-bar progress-bar-warning progress-bar-striped active" role="progressbar" style="width:50%">
    ...
    <div class="progress-bar progress-bar-success progress-bar-striped active" role="progressbar" style="width:10%">
    </div>
</div>

<h2>Your credentials were added successfully.</h2>
<h4><a href="logn.php">Click here</a> to login..</h4>
</div>
