...
<div class="jumbotron"  style="text-align:justify;opacity: 0.96;padding-right: 80px;padding-left: 80px;">
		<img src="img/hyper.jpg"  style="height:300px;width:400px;padding:15px;float:right;">
<h2 style="color:#7E94FF">Hyperlinking Policy</h2>
...
We do not object to you linking directly to the information that is hosted on our site and no prior permission is required for the same.
 ...
 Our website's pages must load into a newly opened browser window of the user. 
</p>
<br><br><br><br><br><br>
</div>
