...
<button type="button" class="btn btn-link btn-md" ><a href="logn.php"><span class="glyphicon glyphicon-log-in"></span> Login</a></button>
  ...
  <div class="jumbotron" style="opacity: 0.9325">

    <div class="row vertical-offset-100">
    	<div class="col-md-4 col-md-offset-4">
    		<div class="panel panel-default">
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" action="lognValidate" role="form" method="post">
                    ...
                    <fieldset>
						...
						<a href="#">Forgot Password</a><br><br> Don't Have an account? <a href="agentreg1.php">Sign Up</a>
			    	</fieldset>
			      	</form>
			    </div>
			</div>
